...
class ViewsManager
{
  ...
  function setFileName($fileName) {
    ...
    if($fileName == "login.php" || $fileName == "singup.php") {
      $this->generateBody();
    } else if($fileName == "home.php" || $fileName =="newproduct.php"){
  ...
  $this->setFileName("singup.php");
  }
  function NewProduct(){
    $this->head->SetTitle("NuevoProducto");
    $this->setFileName("newproduct.php");
    }
